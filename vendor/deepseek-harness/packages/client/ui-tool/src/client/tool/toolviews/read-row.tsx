 ...
 */
export function ReadRow({ toolName, block, cwd, openFile, viewFile, inspect, t }: ReadRowProps) {
  ...
  return (
    <ToolRow
      ...
      onOpenFile={openFile}
      onViewFile={viewFile === undefined ? undefined : (path) => { viewFile({ kind: 'read', path }) }}
      inspect={inspect}
    />
  )
}
