...
export const TurnTailNodeView = memo(function TurnTailNodeView({
  node, openFile, viewFile, forkAt, renderSlot, renderSlotChain, t, useSession,
  ...
  const owner: TurnTailOwnerProps = { turn, seq: closing?.finalNode.seq ?? data.seq, openFile, viewFile }
