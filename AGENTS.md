...
| 协议 | MIT |
| 立项时间 | 2026-06-04 |
| 当前版本 | v0.85.8(修复 dsh web 主壳在旧 runtime 初始化前执行已绑定 SSH 资产的 AI 工具时，桥未持有 `AppHandle` 而报“无 AppHandle，无法建立 SSH 会话”；应用启动时即绑定共享桥句柄，AI 现在可按资产配置实际发起 SSH 连接。) |
