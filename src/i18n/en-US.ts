export default {
 ...
 disconnect: 'Disconnect',
  ...
  ssh: {
    ...
    mfaAppendAtConnect: 'Aliyun Bastion: append 6-digit MFA code at connect time',
    mfaAppendTitle: 'Enter 6-digit MFA Code',
    mfaAppendHint: 'Bastion submits password + 6-digit code as one field. Pick the format below — try "No Space" first; on failure retry with "Space".',
    mfa6digit: '6-digit code',
    mfa6digitPlaceholder: '123456',
    mfaAppendFormat: 'Append format',
    mfaAppendManual: 'I’ll concat it',
