export default {
 ...
 disconnect: '断开',
  ...
  docker: {
    ...
    execFailed: '命令执行失败',
    execWelcome: '输入命令后按 Enter 执行;↑/↓ 浏览历史,Ctrl+L 清屏,cd 可保持工作目录。',
  ...
  ai: {
    ...
    safetyHint: '# 只授权本轮查看和打开对应资产;真实操作继续使用工作区确认与高危拦截。',
    workspaceTitle: 'AI Command Workspace',
    workspaceHint: "输入 {'@'} 选择角色,输入 # 引用 StarHub 工作区。未显式引用的模块不会暴露给模型。",
