...
[![Version](https://img.shields.io/badge/version-v0.68.0-cyan)]()
...
### v0.68.0 (2026-08-15)
- ✨ B 路径 Phase 0 spike Step 2:details 右栏停靠 StarHub 工具工作区(方案 A)——details 席位改 session-maybe(无会话可达、切会话不自动关闭),DetailsPanel 新增 details.workspace 内席,侧栏新增「工具工作区」入口

### v0.67.0 (2026-08-15)
- ✨ B 路径 Phase 0 spike Step 1:壳内 React 工具页签(conversation.view 注册 starhub-tools),无 iframe 直渲 + 顶层帧 Tauri IPC 直调资产列表;3086 独立测试实例验证通过(3085 线上不受影响)
